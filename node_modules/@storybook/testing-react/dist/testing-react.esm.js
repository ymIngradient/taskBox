...
var isValidStoryExport = function isValidStoryExport(storyName, nonStoryExportsConfig) {
  ...
  return isExportStory(storyName, nonStoryExportsConfig) && storyName !== '__namedExportsOrder';
};
...
function composeStory(story, meta, globalConfig) {
  ...
  var combinedParameters = combineParameters(globalConfig.parameters || {}, (meta == null ? void 0 : meta.parameters) || {}, story.parameters || {}, {
